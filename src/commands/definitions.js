...
export const commandData=[
  ...
  new SlashCommandBuilder().setName('stop').setDescription('再生を停止してキューを空にする'),
  ...
  new SlashCommandBuilder().setName('volume').setDescription('音量を変更')
    .addIntegerOption(o=>o.setName('percent').setDescription('音量 1～200').setMinValue(1).setMaxValue(200).setRequired(true)),
